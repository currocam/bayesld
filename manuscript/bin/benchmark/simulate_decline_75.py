...
"""Simulate a decline: Ne=5000 for t >= 75 generations, Ne=500 for t < 75.

Usage:
    simulate_decline_75.py <num_chroms> <chrom_length_bp> <recombination_rate>
...
NE_RECENT, NE_ANCESTRAL, T_CHANGE = 500, 5000, 75
