...
"""Simulate a growth: Ne=500 for t >= 75 generations, Ne=5000 for t < 75.

Usage:
    simulate_growth_75.py <num_chroms> <chrom_length_bp> <recombination_rate>
...
NE_RECENT, NE_ANCESTRAL, T_CHANGE = 5000, 500, 75
