...
"""Fit a two-epoch piecewise-constant Ne(t) model.

Usage:
    fit_two_epoch.py <data.pkl> <recombination_rate> <mutation_rate>
                      <num_workers> <out.nc>
"""
...
def main():
    ...
    model = inference.PiecewiseConstant(num_epochs=2).with_data(
