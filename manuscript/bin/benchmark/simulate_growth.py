...
"""Simulate a recent growth: Ne=500 for t >= 5 generations, Ne=5000 for t < 5.

Usage:
    simulate_growth.py <num_chroms> <chrom_length_bp> <recombination_rate>
...
NE_RECENT, NE_ANCESTRAL, T_CHANGE = 5000, 500, 5
